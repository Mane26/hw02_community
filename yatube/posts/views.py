...
"""Используем переменную константу COUNT_LAST_POSTS, требуется вывести последние 10 постов"""


def group_posts(request, slug):
    """Страница со списком постов - group_posts , отвечающая за запросы, содержимое постов из групп"""
